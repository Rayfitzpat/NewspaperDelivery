...
public class Utility {
    ...
    public boolean ifInvoicesExist(int customerID, int month) {
        String query = "select count(*) as total from invoice where MONTH(invoice_date) = " + month +" AND customer_id = " + customerID + ";";
        return exists(query);
    }
